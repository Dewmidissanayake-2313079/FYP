...
- **MM-DeepFashion Dataset (Kaggle)**: [Official Dataset Link](https://www.kaggle.com/datasets/silverstone1903/deep-fashion-multimodal)
...
- **Survey-Based Demographic Dataset**: A custom dataset collected to capture user preferences across age, gender, and occasion for demographic-aware recommendation.

## 📁 Project Structure

```
├── App/                        # Streamlit Production Interface
│   ├── app.py                  # Main Application Logic
│   ├── style.css               # Frontend Styling
│   ├── config.yaml             # System Configuration
│   └── .env                    # API Security Keys
│
├── object detection model/     # Vision Intelligence (YOLOv8)
│   └── weights/                # Pre-trained Detection weights
│
├── Feature Extraction model/   # Multimodal Embedding Pipeline (CLIP)
│   └── run_feature_extraction.py  # Feature Vector Generation
│
├── Recommendation models/      # Core Research & Benchmarking
│   ├── ML/                    # Traditional Baselines (XGBoost, RF)
│   ├── DL/                    # Deep Learning Baselines (Two-Tower)
│   ├── GraphSAGE/             # Homogeneous Graph Baseline
│   └── GAT/                   # Final Heterogeneous GATv2 Architecture
│
└── Datasets/                  # Data Management
    ├── dataset_with_age_survey_based.csv  # Custom Demographic Dataset
